...
public class CMDService {
    ...
    public List<byte[]> getCertificatesOf(String userId) throws CertificateException, IOException {
        ...
        while(contentPemFile.available() > 0) {
            ...
            certChain.add(certificate.getEncoded());
        }
...
//            return new DEROctetString(value).getEncoded();
    ...
    public byte[] validateOtp(String processId, String userOtp) {
